...
class ShopFragment : Fragment() {
    ...
    private fun buildMarket() {
        ...
        val packs = listOf(
            Triple("کیسه ۵۰۰ سکه", "۲۰٫۰۰۰ تومان", "برای خرید پوست‌های ویژه"),
            Triple("صندوق ۱٬۲۰۰ سکه", "۴۵٫۰۰۰ تومان", "پیشنهاد ویژه پهلوانان"),
            Triple("گنج ۳٬۰۰۰ سکه", "۹۹٫۰۰۰ تومان", "گنجینه شاهان"),
        )
